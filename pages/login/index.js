...
Page({
    ...
    nextPage: function() {
        ...
        if (this.data.pageType == 0) {
            ...
            wx.reLaunch({
                url: '/pages/index/index?referer=' + referer
            });
        }
        if (this.data.pageType == 1) {
            var referer = this.data.pageData.inner ? 1 : 5;
            wx.reLaunch({
                url: '/pages/comDetail/index?referer=' + referer + '&id=' + this.data.pageData.pid + '&storeid=' + this.data.pageData.storeid + '&invitecode=' + this.data.pageData.invitecode
            });
        }
        ...
        if (this.data.pageType == 4) {
            var referer = this.data.pageData.inner ? 1 : 5;
            wx.reLaunch({
                url: '/pages/comDetail/index?referer=' + referer + '&id=' + this.data.pageData.pid + '&storeid=' + this.data.pageData.storeid + '&sceneid=' + this.data.pageData.sceneid
            });
        }
        if (this.data.pageType == 5) {
            if (this.data.pageData.activityOrderId) {
                if (this.data.pageData.type == 'BARGAIN') {
                    wx.reLaunch({
                        url: '/pages/activities/bargainDetail/index?id=' + this.data.pageData.pid + '&activityId=' + this.data.pageData.activityId + '&activityOrderId=' + this.data.pageData.activityOrderId + '&invitecode=' + this.data.pageData.invitecode
                    });
                } else {
                    console.log('拼团分享进入');
                    wx.reLaunch({
                        url: '/pages/activities/splicedDetail/index?id=' + this.data.pageData.pid + '&activityId=' + this.data.pageData.activityId + '&activityOrderId=' + this.data.pageData.activityOrderId + '&progressId=' + this.data.pageData.progressId + '&invitecode=' + this.data.pageData.invitecode
                    });
                }
            } else {
                if (this.data.pageData.type == 'BARGAIN') {
